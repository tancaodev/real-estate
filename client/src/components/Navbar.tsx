    ...
    return (
        <div className='fixed top-0 left-0 w-full z-50 shadow-xl' style={{ height: `${NAVBAR_HEIGHT}px` }}>
            <div className='flex items-center justify-between w-full py-3 px-8 bg-primary-700 text-white'>
                ...
                {!isDashboardPage && <p className='text-primary-200 hidden md:block'>Discover your perfect rental apartment with our advanced search</p>}
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger className='flex items-center gap-2 focus:outline-none'>
                                    <Avatar>
                                        ...
                                        <AvatarFallback className='bg-primary-600'>{authUser.userRole?.[0].toUpperCase()}</AvatarFallback>
                                    </Avatar>
