...
const PropertyTenants = () => {
    ...
    return (
        <div className='dashboard-container'>
            ...
            <Link href='/managers/properties' className='flex items-center mb-4 hover:text-primary-500' scroll={false}>
                <ArrowLeft className='w-4 h-4 mr-2' />
                <span>Back to Properties</span>
            </Link>

            <Header title={property?.name || 'My Property'} subtitle='Manage tenants and leases for this property' />
                                    ...
                                    <TableRow key={lease.id} className='h-24'>
                                        <TableCell>
                                            <div className='flex items-center space-x-3'>
                                                <Image src='/landing-i1.png' alt={lease.tenant.name} width={40} height={40} className='rounded-full' />
                                                <div>
                                        ...
                                        <TableCell>
                                            ...
                                            >
                                                {getCurrentMonthPaymentStatus(lease.id) === 'Paid' && <Check className='w-4 h-4 inline-block mr-1' />}
