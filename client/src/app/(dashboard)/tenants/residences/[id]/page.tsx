                        ...
                        <div className='flex flex-col justify-between'>
                            <div>
                                <div className='flex items-start gap-5'>
                                    ...
                                    <span className='text-sm font-medium border border-primary-700 text-primary-700 px-3 py-1 rounded-full'>Default</span>
                                </div>
    ...
    return (
        <div className='bg-white rounded-xl shadow-md overflow-hidden p-6 flex-1 flex flex-col justify-between'>
            ...
            <div className='flex gap-5'>
                ...
                <div className='flex flex-col justify-between'>
                    <div>
                        <div className='bg-green-500 w-fit text-white px-4 py-1 rounded-full text-sm font-semibold'>Active Leases</div>
                    ...
                    <div className='text-xl font-bold'>
                        ${currentLease.rent} <span className='text-gray-500 text-sm font-normal'>/ night</span>
                    </div>
                </div>
            </div>
            {/* Dates */}
                        ...
                        {payments.map((payment) => (
                            <TableRow key={payment.id} className='h-16'>
                                ...
                                <TableCell>
                                    ...
                                    >
                                        {payment.paymentStatus === 'Paid' ? <Check className='w-4 h-4 inline-block mr-1' /> : null}
