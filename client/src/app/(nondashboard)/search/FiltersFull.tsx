    ...
    const handleLocationSearch = async () => {
        try {
            const response = await fetch(
                `https://api.mapbox.com/geocoding/v5/mapbox.places/${encodeURIComponent(localFilters.location)}.json?access_token=${
            ...
            <div className='flex flex-col space-y-6'>
                ...
                <div className='flex gap-4'>
                    <div className='flex-1'>
                        ...
                        <Select value={localFilters.beds || 'any'} onValueChange={(value) => setLocalFilters((prev) => ({ ...prev, beds: value }))}>
                    ...
                    <div className='flex-1'>
                        ...
                        <Select value={localFilters.baths || 'any'} onValueChange={(value) => setLocalFilters((prev) => ({ ...prev, baths: value }))}>
                            <SelectTrigger className='w-full rounded-xl'>
                        ...
                        {Object.entries(AmenityIcons).map(([amenity, Icon]) => (
                            <div
                                ...
                                className={cn(
                                    ...
                                    localFilters.amenities.includes(amenity as AmenityEnum) ? 'border-black' : 'border-gray-200'
                                )}
