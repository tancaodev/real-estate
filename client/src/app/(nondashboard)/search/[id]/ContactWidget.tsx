        ...
        <div className='bg-white border border-primary-200 rounded-2xl p-7 h-fit min-w-[300px]'>
            ...
            <div className='flex items-center gap-5 mb-4 border border-primary-200 p-4 rounded-xl'>
                ...
                <div>
                    ...
                    <div className='text-lg font-bold text-primary-800'>(424) 340-5574</div>
                </div>
            </div>
            <Button className='w-full bg-primary-700 text-white hover:bg-primary-600' onClick={handleButtonClick}>
