import { useGetTenantQuery, useAddFavoritePropertyMutation, useGetAuthUserQuery, useGetPropertiesQuery, useRemoveFavoritePropertyMutation } from '@/state/api'
    ...
    return (
        <div className='w-full'>
            <h3 className='text-sm px-4 font-bold'>
                {properties?.length} <span className='text-gray-700 font-normal'>Places in {filters.location}</span>
            </h3>
            <div className='flex'>
